...
#define AWS_IOT_MQTT_CLIENT_ID         "linkittest" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "linkittest" //IMPORTANT: for a temporary work around, you also need to modify the same name in your library for aws_iot_config.h (under arduino library path)
...
#define AWS_IOT_TOPIC_NAME             "devices/linkittest/messages/events/" //MQTT subscribe/publish Topic name
// =================================================
